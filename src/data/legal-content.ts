export type LegalDocument = 'privacy' | 'terms' | 'cookie' | 'compliance' | 'documentation';

export const legalContent: Record<LegalDocument, { title: string; content: string }> = {
    terms: {
...
If you are using the Service as an individual, you represent that you are legally competent to enter into a binding agreement.

These Terms constitute a legally binding agreement between you and Tekisho.
...
We reserve the right to modify, enhance, suspend, or discontinue any part of the Service at any time.
Material feature changes that significantly impact active subscriptions will be communicated with reasonable advance notice.
...
You are responsible for maintaining the confidentiality of your login credentials and for all activities conducted through your account. You must notify us immediately of any unauthorized access.

Tekisho is not liable for losses arising from your failure to safeguard account credentials.

## 4. Acceptable Use

You agree to use the Service only for lawful business or professional purposes.
...
Payments are processed through Razorpay or other authorized payment processors. By providing payment details, you authorize us to charge applicable subscription fees and taxes.

### 5.3 Auto-Renewal

Subscriptions renew automatically unless cancelled before the renewal date. Renewal reminders will be sent prior to billing.

### 5.4 Taxes

All fees are exclusive of applicable taxes (including GST). You are responsible for paying all applicable taxes as per Indian law.

## 6. Cancellation and Refunds

### 6.1 Cancellation

You may cancel your subscription at any time through your account or by contacting support. Cancellation stops future billing but does not automatically entitle you to a refund.

### 6.2 Refund Eligibility

Refund requests must be submitted within **five (5) business days** of payment and are subject to usage-based review.
Approved refunds will be processed within **5-7 business days** and credited to the original payment method within **7-10 business days** depending on your bank or payment provider.
Refunds may be denied where significant use or value has already been derived.

### 6.3 Non-Refundable Scenarios
...
- Change of mind beyond eligibility window

### Consumer Law Clarification

Nothing in this section limits any mandatory rights available to individual users under applicable consumer protection laws, to the extent such laws apply.

## 7. Intellectual Property

### 7.1 Platform Ownership

All intellectual property in the Service (excluding User Data) belongs to Tekisho.
You are granted a limited, non-exclusive, non-transferable, revocable license to use the Service solely for internal business or professional purposes.

### 7.2 User Data

You retain ownership of data you upload. You grant Tekisho a limited license to process such data solely to provide and improve the Service and comply with legal obligations.

### 7.3 Feedback

Any feedback you provide may be used by Tekisho without restriction or compensation.

## 8. Availability and Support

The Service is provided on an "as-available" basis. While we aim for high uptime, uninterrupted availability is not guaranteed. Support response times may vary by plan.

## 9. Termination

### 9.1 Termination by You

You may terminate your account at any time. Termination takes effect at the end of the current billing cycle.

### 9.2 Termination by Us

We may suspend or terminate access for violations, non-payment, security risks, fraud, or abusive behavior.

### 9.3 Data Retention

Following termination, data may be retained for up to 90 days for reactivation or export, after which it will be permanently deleted, subject to legal requirements.
...
Tekisho's total liability shall not exceed the fees paid by you in the twelve (12) months preceding the claim or INR 10,000, whichever is lower.

## 11. Indemnification

You agree to indemnify and hold harmless Tekisho from claims arising out of:
...
You expressly agree that this dispute resolution clause applies to both individual and business users.

Parties shall attempt good-faith negotiation before initiating formal proceedings.

## 13. Changes to Terms

We may update these Terms from time to time. Material changes will be communicated in advance. Continued use of the Service after the effective date constitutes acceptance.

## 14. General Provisions

- **Entire Agreement:** These Terms constitute the entire agreement between you and Tekisho.
...
- **No Third-Party Beneficiaries:** No third-party rights are created.
...
Tekisho Infotech Private Limited (“Tekisho”, “we”, “us”, or “our”) operates LeadQ, a cloud-based lead management and sales pipeline platform (the “Service” or “Platform”).
...
LeadQ may be used by:

- Businesses and organizations, and
- Individual professionals, including freelancers, consultants, sole proprietors, and independent users.

By accessing or using the Service, you acknowledge that you have read and understood this Privacy Policy. If you do not agree, you must discontinue use of the Service.
...
- **Data Fiduciary (Controller):** For account information, billing data, platform administration, security, and marketing communications.
- **Data Processor:** For lead, contact, and customer data uploaded by users into the Platform (“Customer Data”).

This structure aligns with the Digital Personal Data Protection Act, 2023 (India) and global data protection principles.
...
- Lead names and contact details
- Business contact information
- Interaction notes, communications, and pipeline data
...
Tekisho does not store full credit card numbers, UPI credentials, CVV, or bank account details. Payments are processed securely by authorized payment processors.

**Communications**

- Support requests
- Emails or messages exchanged with our team
...
- Log data (timestamps, error logs, access records)
- Usage data such as features accessed and session duration

This information is used strictly for security, analytics, and platform improvement.
...
- Payment processors
- Authentication providers (if enabled)
- Publicly available sources
- Marketing or referral partners

Such data is used only for legitimate business purposes and in accordance with this Privacy Policy.
...
- Product improvement, analytics, and performance monitoring
...
Payments are processed through Razorpay or other authorized payment processors compliant with PCI-DSS standards.

Tekisho retains only limited transaction metadata necessary for:

- Accounting
- Customer support
- Dispute resolution

For details on Razorpay’s practices, please refer to their privacy policy.

## 7. Data Security

We implement appropriate technical, administrative, and organizational safeguards, including:
...
While we follow industry best practices, no system can be guaranteed 100% secure.
...
With trusted third parties who support:
...
Such providers are bound by contractual confidentiality and security obligations.

### 8.2 Legal Requirements

Where required to comply with applicable law, court orders, or lawful government requests.

### 8.3 Business Transfers

In the event of a merger, acquisition, or restructuring, data may be transferred subject to equivalent privacy protections. Users will be notified of material changes.

### 8.4 Aggregated or Anonymized Data

We may use and share anonymized data that cannot identify individuals for analytics or research.
...
| Cancelled accounts | Up to 90 days for reactivation/export |
| Backups | Up to 180 days |
| Legal / tax records | Up to 7 years |

After retention periods expire, data is securely deleted or anonymized.

## 10. Your Rights

Under applicable laws, including the DPDP Act, 2023, you may have the right to:
...
Requests may be submitted to contact@tekisho.ai. We respond within 30 days.
...
You may manage cookies through browser settings. Disabling essential cookies may affect functionality.

## 12. International Data Transfers

Data is primarily processed in India. Where international transfers occur, we ensure appropriate contractual and legal safeguards are in place.

## 13. Children’s Privacy

LeadQ is not intended for individuals under 18 years of age. We do not knowingly collect personal data from minors.

## 14. Third-Party Links

The Service may link to third-party sites. Tekisho is not responsible for their privacy practices.

## 15. Changes to This Policy

We may update this Privacy Policy periodically. Material changes will be communicated in advance. Continued use after the effective date constitutes acceptance.

## 16. Grievance Redressal

In accordance with Indian law, users may raise privacy-related concerns at:

**Email:** contact@tekisho.ai

**Response Time:** Within 30 days

A Grievance Officer will be appointed as required.
...
- Telecommunications and communication regulations
- Financial services and payment processing standards
...
- **Transparency:** Providing clear information about our compliance practices.

### 1.3 Compliance Governance Structure
- **Board of Directors:** Oversees enterprise risk management and compliance.
- **Executive Leadership:** CEO, CTO, CFO, and General Counsel hold ultimate accountability.
- **Compliance Function:** Led by the Chief Compliance Officer (CCO) and Data Protection Officer (DPO).
...
#### 2.1.2 California Consumer Privacy Act (CCPA) and CPRA
Compliance Status: Fully compliant with CCPA (2020) and CPRA (2023).

#### 2.1.3 Digital Personal Data Protection Act (DPDPA) - India
Compliance Status: Fully compliant (enforcement date pending).

### 2.2 Privacy Compliance Processes
We maintain comprehensive data mapping, conduct PIAs/DPIAs for new features, and manage data subject rights with transparent response timelines.

### 2.3 Privacy Compliance Certifications
- **Current:** GDPR & CCPA self-assessed.
- **Planned:** ISO 27701 (Q3 2026).

## 3. Information Security Compliance

### 3.1 Security Frameworks and Standards
- **ISO 27001:** Implementation in progress (target Q3 2026).
- **SOC 2 Type II:** Implementation in progress (target Q4 2026).
- **NIST CSF:** Implemented and maintained.
- **CIS Controls:** Implemented version 8.

### 3.2 Security Controls Implementation
- **Access Control:** Mandatory MFA for employees, RBAC, and SSO support.
- **Encryption:** TLS 1.3 in transit, AES-256 at rest.
- **Network Security:** WAF, DDoS protection, and regular vulnerability scans.
- **Application Security:** Secure SDL, SAST/DAST, and OWASP Top 10 mitigation.
- **Backup/DR:** Daily backups and annual disaster recovery testing.

### 3.3 Physical and Environmental Security
Infrastructure hosted in AWS data centers with 24/7 security and biometric access.

## 4. Industry-Specific Compliance
Adherence to CRM industry best practices and AI/ML ethics (Fairness, Transparency, Accountability).

## 5. Telecommunications and Communication Compliance
- **TCPA (US):** Prior express written consent and DNC compliance.
...
Compliance with U.S. EAR, OFAC sanctions, and EU/UN/India trade restrictions.

## 8. Employment and Labor Compliance
...
- **Sustainability:** Carbon neutral target by 2027.
- **Social:** DEI initiatives and technology access programs.

## 12. Compliance Monitoring and Auditing
Continuous monitoring via SIEM/DLP, quarterly internal audits, and annual third-party audits.

## 13. Incident Response and Breach Notification
Documented SIRP with 72-hour notification commitment for high-risk breaches as per GDPR.

## 14. Third-Party and Vendor Compliance
Rigorous vendor risk assessment, DPAs, and continuous monitoring of critical sub-processors.

## 15. Training and Awareness
Mandatory annual compliance training for all employees and role-specific security training.

## 16. Compliance Reporting and Transparency
Annual transparency reports and real-time Trust Center available at https://leadq.ai/trust.

## 17. Contact Information
- **Compliance:** compliance@leadq.ai
- **Privacy:** privacy@leadq.ai
- **DPO Address:** 505 A, 5th Floor, Techno 1, Gachibowli Road, Raidurg, Hyderabad, Telangana - 500032

...
//                     }`}>
//                     <User className={`w-4 h-4 ${isSelected ? 'text-green-400' : 'text-slate-400'}`} />
//                   </div>
//                   <div>
...
const EnrichedCard = ({ profile, visibleFields }: { profile: EnrichedProfile; visibleFields: string[] }) => {
  const fields = [
    ...
    { id: 'role', icon: Briefcase, label: 'Role', value: `${profile.role} @ ${profile.company}`, color: 'text-slate-400' },
    { id: 'email', icon: Mail, label: 'Email', value: profile.email, color: 'text-slate-400' },
    { id: 'location', icon: MapPin, label: 'Location', value: profile.location, color: 'text-slate-400' },
    { id: 'linkedin', icon: Link2, label: 'LinkedIn', value: profile.linkedin, color: 'text-slate-400' },
  ...
  const placeholderFields = [
    { id: 'identity', icon: Shield, label: 'Verified Identity', value: '—', color: 'text-slate-500' },
    { id: 'role', icon: Briefcase, label: 'Role', value: '—', color: 'text-slate-500' },
    { id: 'email', icon: Mail, label: 'Email', value: '—', color: 'text-slate-500' },
  ];
